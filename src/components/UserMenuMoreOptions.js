                        ...
                        <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                                <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                                    ...
                                    <MenuItem onClick={handleDrawerCloseForum}><ListItem ><ListItemIcon><PeopleIcon style={{color:"rgba(0,1,14,0.74)",border:"none",outline:"none"}} /></ListItemIcon><ListItemText primary={<Typography>{t('Forum')}</Typography>}/></ListItem></MenuItem>
