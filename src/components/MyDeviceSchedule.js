...
import {useTheme, Box, Grid, ListItem, Typography, Paper, List, ListItemText} from "@mui/material";
...
export default withTranslation()(MyDeviceSchedule)
