...
const GET_Device = gql`query { dtc(id:"ck4colaq2snfv0993khmfrn0y") {id name_EN name_UA device_id{ name_UA name_EN module tr{name_TR_UA name_TR_EN} }}}`;

function StandardsTF() {
    const handleBack = () => {
        history.goBack();
    };
    return (
...
export default withTranslation()(StandardsTF);
