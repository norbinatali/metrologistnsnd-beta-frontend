...
const GET_Device = gql`query { dtc(id:"ck4colwpvvg420922bssjy333") {id name_EN name_UA device_id{ name_UA name_EN module tr{name_TR_UA name_TR_EN} }}}`;


function StandardsPR({t}){
...
export default withTranslation()(StandardsPR);
