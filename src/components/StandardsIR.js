...
const GET_Device = gql`query { dtc(id:"ck4comkhvvg830922mm719hn4") {id name_EN name_UA device_id{ name_UA name_EN module tr{name_TR_UA name_TR_EN} }}}`;


function StandardsIR({t}){
...
export default withTranslation()(StandardsIR);
