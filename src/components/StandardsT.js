...
const GET_Device = gql`query { dtc(id:"ck4cokk9qvfvn0922s2dovf72") {id name_EN name_UA device_id{ name_UA name_EN module tr{name_TR_UA name_TR_EN} }}}`;


function StandardsT({t}){
...
export default withTranslation()(StandardsT);
