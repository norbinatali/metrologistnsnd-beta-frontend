                        ...
                        <MuiThemeProvider>
                             <Grid container spacing={5} >
                                <Grid item xs={12} md={4} >
                                    <Typography style={{color:"#fff", marginTop:"50%"}}>  <h4 >{t('New software for metrologists, manufacturers and people who want to know more about measuring technology')}</h4></Typography>
                                </Grid>
                               <Grid item xs={12} md={4} >
                                    <img src={FrontPic}/>
                                </Grid>
